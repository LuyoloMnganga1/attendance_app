...
import 'package:attendance_app/views/widgets/activation/take_picture_sheet.dart';
...
class _ActivationState extends State<Activation> {
  ...
  List<Map<String, String>> warning = [
    {'text': 'Face the camera straight.', 'img': 'assets/face-front.png'},
    {'text': 'Turn your face 30 degrees to the right', 'img': 'assets/face-right.png'},
    {'text': 'Turn your face 30 degrees to the left', 'img': 'assets/face-left.png'},
  ];
  Timer? _timer;
    ...
    _cameraService.cameraController?.startImageStream((image) async {
      if (_cameraService.cameraController != null) {
        ...
        try {
          ...
          if (_detectorService.faces.isNotEmpty && _detectorService.isFaceAtBox()) {
            setState(() {
  ...
  Future<void> onTakeCamera() async {
    ...
    try {
      ...
      controller = scaffoldKey.currentState?.showBottomSheet((context) => const TakePictureSheet());
    } catch (e) {
