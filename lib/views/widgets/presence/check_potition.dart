...
import 'package:attendance_app/model/presence_location_model.dart';
import 'package:attendance_app/utils/theme.dart';
import 'package:flutter_map/flutter_map.dart';
import 'package:flutter_map/plugin_api.dart';
import 'package:latlong2/latlong.dart';
import 'package:attendance_app/views/widgets/components/circle_pulse.dart';

class CheckPosition extends StatefulWidget {
  const CheckPosition({
    super.key,
  ...
  @override
  State<CheckPosition> createState() => _CheckPositionState();
}

class _CheckPositionState extends State<CheckPosition> {
  ...
  Widget build(BuildContext context) {
    ...
    final longitude = data?.location?.longitude ?? (110.355243).toString();
    final radius = data?.location?.radius ?? 100;

    String status = 'Checking location';
                      ...
                      markers: [
                        ...
                        Marker(
                          point: LatLng(
                            ...
                            data?.current.longitude ?? double.parse(longitude),
                          ),
                          width: 80,
                          height: 80,
                          builder: (context) => Icon(
